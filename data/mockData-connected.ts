...
import type { User, Account, Transaction, Investment, Goal, NetWorthDataPoint, PortfolioDataPoint, BudgetItem, Subscription } from '../types';
...
export const transactions: Transaction[] = [
  { id: 'ct1', date: '2024-07-28', merchant: 'Trader Joe\'s', amount: 88.12, category: 'food', account: 'Amex Gold' },
  { id: 'ct2', date: '2024-07-27', merchant: 'Lyft', amount: 18.50, category: 'transport', account: 'Amex Gold' },
  { id: 'ct3', date: '2024-07-26', merchant: 'Best Buy', amount: 1299.00, category: 'shopping', account: 'Amex Gold' },
...
// FIX: Removed 'assets' and 'liabilities' properties to match the NetWorthDataPoint type.
export const netWorthHistory: NetWorthDataPoint[] = [
    { month: 'Jan', netWorth: 55000 },
    { month: 'Feb', netWorth: 57500 },
    { month: 'Mar', netWorth: 64000 },
    { month: 'Apr', netWorth: 67500 },
    { month: 'May', netWorth: 72000 },
    { month: 'Jun', netWorth: 80050 },
];
...
export const budgetItems: BudgetItem[] = [
    { category: 'food', spent: 720.50, budget: 700 },
    { category: 'transport', spent: 150.00, budget: 200 },
    { category: 'shopping', spent: 1800.00, budget: 1000 },
    { category: 'bills', spent: 300.00, budget: 300 },
    { category: 'other', spent: 80.00, budget: 150 },
];

// FIX: Added missing 'subscriptions' data required by the FinancialData type.
